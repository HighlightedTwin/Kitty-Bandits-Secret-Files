...
public class PlayerController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        shieldPrefab.SetActive(false); //added this so the shield doesn't show at the start
    ...
    IEnumerator WeaponPowerDown()
    {
        ...
        weaponType = 1;
        gameManager.ManagePowerupText(0);
        shieldActive = false; //so the shield's power goes away
        shieldPrefab.SetActive(false); //so the actual shield goes away
        gameManager.PlaySound(2);
    }
